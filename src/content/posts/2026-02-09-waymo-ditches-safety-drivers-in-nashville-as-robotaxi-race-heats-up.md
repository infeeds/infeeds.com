---
layout: post
title: "Waymo Ditches Safety Drivers in Nashville as Robotaxi Race Heats Up"
description: "Alphabet's self-driving unit removes human operators from test vehicles in Nashville, signaling an imminent robotaxi launch in partnership with Lyft."
date: 2026-02-09 08:00:17 +0530
author: adam
...
Here's where things get interesting. Waymo isn't going solo in Nashville. They've teamed up with Lyft to launch the service later this year, though riders will initially need to use the Waymo app directly. Eventually, you'll be able to hail a self-driving Waymo through Lyft's app too, which makes sense from a [business](https://infeeds.com/tags/business) perspective. Why limit your customer base when you can tap into Lyft's existing user network?
...
The Nashville rollout is part of a much bigger picture. Waymo now operates commercial robotaxi services in six major markets: Atlanta, Austin, Los Angeles, Miami, San Francisco Bay Area, and Phoenix. That's a pretty impressive footprint for a [technology](https://infeeds.com/tags/technology) that still makes most people nervous.
...
The question isn't really whether Waymo can launch in more cities anymore. They've proven they can do that. The real question is whether all this expansion actually leads to a sustainable [business](https://infeeds.com/tags/business) model or if we're just watching a very well-funded company burn through cash while hoping the economics eventually work out.